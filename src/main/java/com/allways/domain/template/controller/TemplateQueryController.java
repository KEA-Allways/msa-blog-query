...
import com.allways.domain.template.service.TemplateQueryService;
...
public class TemplateQueryController {
    ...
    public Response readAll(@RequestHeader(value = "userSeq") Long userSeq) {
        return Response.success(templateQueryService.readAll(userSeq));
    }
    ...
    public Response readOne(@PathVariable Long templateSeq) {
        return Response.success(templateQueryService.readOne(templateSeq));
    }
}