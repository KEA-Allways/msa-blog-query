...
public class PostQueryController {
	...
	@GetMapping("/api/post")
	@ResponseStatus(HttpStatus.OK)
	public Response readAllPosts(@RequestHeader(value = "userSeq") Long userSeq,
								 @PageableDefault Pageable pageable) {
		Page<UserAllPostListResponse> userAllPostListResponse =
				postQueryService.readAllPosts(userSeq, pageable);
